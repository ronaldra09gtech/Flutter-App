...
class PakiPilaDirectionScreen extends StatefulWidget {

  final BookingDetails? bookingDetails;
  PakiPilaDirectionScreen({this.bookingDetails});
  ...
  @override
  State<PakiPilaDirectionScreen> createState() => _PakiPilaDirectionScreenState();
}

class _PakiPilaDirectionScreenState extends State<PakiPilaDirectionScreen> with TickerProviderStateMixin {
  ...
  getpakipila(bookingID)
  {
    FirebaseFirestore.instance
        ...
        .then((snap){
          ...
          newprice = double.parse(price) + double.parse(perhalfhr);
        });
  }
  ...
  {
    pickuptime = DateTime.now().millisecondsSinceEpoch.toString();
    FirebaseFirestore.instance
        .collection("booking")
        .doc(getOrderID).update({
      "status": "delivering",
  ...
  confirmParcelHasBeenDelivered(getOrderID)
  {
    ...
    String timeee = hour.toString()+":"+minute.toString()+":"+timerr.toString();
    dropofftime = DateTime.now().millisecondsSinceEpoch.toString();
    FirebaseFirestore.instance
        .collection("booking")
        .doc(getOrderID).update({
      "status": "ended",
      "riderUID": sharedPreferences!.getString("email"),
      "dropOffUpTime": dropofftime,
      "timetaken":timeee,
    });
  }
  ...
  void initState() {
    ...
    super.initState();
    getpakipila(widget.bookingDetails!.bookID);
  }
        ...
        body: Stack(
          children: [
            GoogleMap(
              ...
              initialCameraPosition: PakiPilaDirectionScreen._kGooglePlex,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          ...
                          {
                            getPlaceDirection();
                            displayRideDetailsContainer(widget.bookingDetails!.bookID!);
                          },
                          child: Container(
                            decoration: const BoxDecoration(
                        ...
                        Padding(
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  Text(hour.toString()+":"+minute.toString()+":"+timerr.toString()),
                                ],
                              ),
                            ),
                          ),
                                  ...
                                  onTap: () async
                                  {
                                    if(_controller.isNotEmpty)
                                    {
                                      ...
                                      FirebaseFirestore.instance
                                        ...
                                        {
                                          double total = ((totalMinutes/60)*double.parse(perhalfhr)) +  double.parse(basefee) ;
                                          double subtotal = total * double.parse(pakiPilafees);
                                          double finaltotal = total - subtotal;
                                          double newload = double.parse(load) - finaltotal;
                                          FirebaseFirestore.instance
                                        ...
                                        {
                                          double totalamount = ((totalMinutes/60)*double.parse(perhalfhr)) +  double.parse(basefee);
                                          double subtotal = totalamount * double.parse(pakiPilafees);
                                          double totall = totalamount - subtotal;
                                          double newloadbal = double.parse(load) + totall;
                                          FirebaseFirestore.instance
                                              .collection("pilamokoqueuer")
                                              .doc(sharedPreferences!.getString("email"))
                                              .update({
