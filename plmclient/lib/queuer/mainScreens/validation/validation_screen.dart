    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
            ...
            child: Column(
              children: [
                ...
                InkWell(
                    ...
                    child: OrcrUrl != null && pilamokoqueuerOrcrUrl ==""
                        ? Padding(
                      padding: const EdgeInsets.all(10.0),
                      child: Container(
                        width: MediaQuery.of(context).size.width-20,
            ...
            child: Column(
              children: [
                ...
                InkWell(
                    ...
                    child: BillingUrl != null && pilamokoqueuerBillingUrl!.isEmpty
                        ? Padding(
                      padding: const EdgeInsets.all(10.0),
                      child: Container(
                        width: MediaQuery.of(context).size.width-20,
          ...
          pilamokoqueuerBillingUrl!.isNotEmpty && pilamokoqueuerLicenseUrl!.isNotEmpty && pilamokoqueuerOrcrUrl!.isNotEmpty
              ? Padding(
