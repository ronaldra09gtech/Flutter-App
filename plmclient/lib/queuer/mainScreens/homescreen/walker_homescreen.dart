...
class WalkerHomeScreen extends StatefulWidget {
  const WalkerHomeScreen({Key? key}) : super(key: key);

  @override
  _WalkerHomeScreenState createState() => _WalkerHomeScreenState();
}
      ...
      body: Container(
        ...
        child: GridView.count(
          ...
          children: [
            ...
            makeDashboardItem("Document Assistant", Icons.file_copy_outlined,2),
            makeDashboardItem("Paki-Proxy", Icons.person_pin, 3),
          ],
        ),
      ),
    );
