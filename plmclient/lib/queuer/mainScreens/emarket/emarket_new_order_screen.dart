...
class EmarketNewOrdersScreen extends StatefulWidget
{
  @override
  _EmarketNewOrdersScreenState createState() => _EmarketNewOrdersScreenState();
}

class _EmarketNewOrdersScreenState extends State<EmarketNewOrdersScreen>
{
  @override
      ...
      child: Scaffold(
        ...
        body: StreamBuilder<QuerySnapshot> (
          stream: FirebaseFirestore.instance
              ...
              .where("serviceType", isEqualTo: "emarket")
