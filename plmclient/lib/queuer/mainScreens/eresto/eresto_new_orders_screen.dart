...
class ErestoNewOrdersScreen extends StatefulWidget
{
  @override
  _ErestoNewOrdersScreenState createState() => _ErestoNewOrdersScreenState();
}

class _ErestoNewOrdersScreenState extends State<ErestoNewOrdersScreen>
{
  @override
      ...
      child: Scaffold(
        ...
        body: StreamBuilder<QuerySnapshot> (
          stream: FirebaseFirestore.instance
              ...
              .where("serviceType", isEqualTo: "eresto")
