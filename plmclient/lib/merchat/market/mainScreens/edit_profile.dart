...
class _EditProfileState extends State<EditProfile> {
  ...
  Future saveDataToFirestore2() async {
    FirebaseFirestore.instance
        ...
        .update({
      "pilamokoemarketEmail": emailController.text.trim(),
      "pilamokoemarketName": nameController.text.trim(),
      "pilamokoemarketAvatarUrl": sharedPreferences!.getString("photoUrl"),
  ...
  Future saveDataToFirestore() async {
    FirebaseFirestore.instance
      ...
      "pilamokoemarketEmail": emailController.text.trim(),
      "pilamokoemarketName": nameController.text.trim(),
      "pilamokoemarketAvatarUrl": pilamokotlpImageUrl,
      "phone": phoneController.text.trim(),
      "address": completeAddress,
      "lat": position!.latitude,
      "lng": position!.longitude,
