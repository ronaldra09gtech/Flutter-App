...
import 'package:plmclient/merchat/market/widgets/customTextField.dart';
import 'package:plmclient/merchat/market/widgets/error_dialog.dart';
import 'package:plmclient/merchat/market/widgets/loading_dialog.dart';
import '../../../client/splashScreen/splashScreen.dart';
import '../../../main.dart';
import '../../../queuer/splashScreen/splashScreen.dart';
import '../../mall/splashScreen/splashScreen.dart';
  ...
  Future readDataAndSetDataLocally(User currentUser) async
  {
    await FirebaseFirestore.instance.collection("pilamokoemarket")
      ...
      if(snapshot.exists)
      {
        ...
        await sharedPreferences!.setString("email", snapshot.data()!["pilamokoemarketEmail"]);
