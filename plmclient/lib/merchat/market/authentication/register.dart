...
class _RegisterScreenState extends State<RegisterScreen>
{
  ...
  void authenticatepilamokotlpAndSignUp() async
  {
    ...
    if(currentUser != null)
    {
      saveDataToFirestore(currentUser!).then((value){
        ...
        Route newRoute = MaterialPageRoute(builder: (c) => HomeScreenEmarket());
  ...
  {
    FirebaseFirestore.instance.collection("pilamokoemarket").doc(currentUser.uid).set({
      "pilamokoemarketUID": currentUser.uid,
      "pilamokoemarketEmail": currentUser.email,
    ...
    await sharedPreferences!.setString("userType", "emarket" );
