...
class _EditProfileState extends State<EditProfile> {
  ...
  Future saveDataToFirestore2() async {
    FirebaseFirestore.instance
        ...
        .update({
      "pilamokosellerEmail": emailController.text.trim(),
      "pilamokosellerName": nameController.text.trim(),
      "pilamokosellerAvatarUrl": sharedPreferences!.getString("photoUrl"),
  ...
  Future saveDataToFirestore() async {
    FirebaseFirestore.instance
      ...
      "pilamokosellerEmail": emailController.text.trim(),
      "pilamokosellerName": nameController.text.trim(),
      "pilamokosellerAvatarUrl": pilamokotlpImageUrl,
      "phone": phoneController.text.trim(),
      "address": completeAddress,
      "lat": position!.latitude,
      "lng": position!.longitude,
