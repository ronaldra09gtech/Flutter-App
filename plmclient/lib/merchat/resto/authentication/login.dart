...
import 'package:plmclient/merchat/resto/authentication/forgot_password.dart';
  ...
  Future readDataAndSetDataLocally(User currentUser) async
  {
    await FirebaseFirestore.instance.collection("pilamokoseller")
      ...
      if(snapshot.exists)
      {
        ...
        await sharedPreferences!.setString("email", snapshot.data()!["pilamokosellerEmail"]);
