...
class _ItemsUploadScreenState extends State<ItemsUploadScreen> {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.push(
                context, MaterialPageRoute(builder: (c) => const HomeScreenEresto()));
          },
        ),
      ),
      body: Container(
  ...
  saveInfo(String downloadUrl)
  {
    ...
    ref.doc(uniqueIDName).set({
      ...
      "pilamokosellerUID": sharedPreferences!.getString("uid"),
      "pilamokosellerName": sharedPreferences!.getString("name"),
