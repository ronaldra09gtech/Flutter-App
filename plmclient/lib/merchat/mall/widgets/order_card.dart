...
import 'package:plmclient/merchat/mall/mainScreens/new_order_detail_screen.dart';
...
class OrderCard extends StatelessWidget
{
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: ()
      {
        Navigator.push(context, MaterialPageRoute(builder: (c)=> OrderDetailsSrceen2(orderID: orderID)));
      },
      child: Container(
