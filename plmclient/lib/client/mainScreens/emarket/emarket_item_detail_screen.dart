...
class EmarketItemDetailsScreen extends StatefulWidget
{
  final EmarketItems? model;
  EmarketItemDetailsScreen({this.model});

  @override
  _EmarketItemDetailsScreenState createState() => _EmarketItemDetailsScreenState();
}

class _EmarketItemDetailsScreenState extends State<EmarketItemDetailsScreen> {
