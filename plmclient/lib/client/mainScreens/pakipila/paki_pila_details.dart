...
class PakiPilaBookingDetails extends StatefulWidget {
  ...
  String? notes;
  String? phone;
  PakiPilaBookingDetails({this.phone,this.dropoffplaceID,this.pickupplaceID,this.notes,this.dropofflocation,this.pickuplocation});
  @override
  _PakiPilaBookingDetailsState createState() => _PakiPilaBookingDetailsState();
}

class _PakiPilaBookingDetailsState extends State<PakiPilaBookingDetails> with TickerProviderStateMixin {
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Row(
                                children: [
                                  Expanded(
                                    child: Text((tripDirectionDetails != null) ? 'Estimated Price \₱${AssistantMethods.calculateFaresPerhr(tripDirectionDetails!)}': ""),
                                  ),
                                ],
                              ),
                            ),
                            ...
                            Text("There will be additional ₱${pakiPilaPerHour} charge per hour  "),
                            Row(
  ...
  Future createBooking() async {
    if(isDriverOnline)
    {
      ...
      {
        if(double.parse(loadWallet) > AssistantMethods.calculateFaresPerhr(tripDirectionDetails!))
        {
          double newloadWallet = double.parse(loadWallet) - AssistantMethods.calculateFaresPerhr(tripDirectionDetails!);
