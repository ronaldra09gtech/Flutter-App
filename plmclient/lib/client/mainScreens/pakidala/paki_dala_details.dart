...
class PakiDalaDetails extends StatefulWidget {
  ...
  String? notes;
  String? phone;
  PakiDalaDetails({this.phone,this.dropoffplaceID,this.pickupplaceID,this.notes,this.dropofflocation,this.pickuplocation});

  @override
  _PakiDalaDetailsState createState() => _PakiDalaDetailsState();
}
