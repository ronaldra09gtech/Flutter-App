...
class ErestoItemDetailsScreen extends StatefulWidget
{
  final ErestoItems? model;
  ErestoItemDetailsScreen({this.model});

  @override
  _ErestoItemDetailsScreenState createState() => _ErestoItemDetailsScreenState();
}

class _ErestoItemDetailsScreenState extends State<ErestoItemDetailsScreen> {
