...
import 'package:plmclient/client/mainScreens/order_dertails_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: ListView.builder(
        ...
        {
          ErestoItems model = ErestoItems.fromJson(data![index].data()! as Map<String, dynamic>);
...
Widget placeOrderDesignWidget(ErestoItems model, BuildContext context, separateQuantitiesList)
{
  return Column(
